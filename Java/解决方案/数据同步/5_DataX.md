...
![datax_why_new](5_DataX.assets/93b7fc1c-6927-11e6-8cda-7cf8420fc65f.png)
...
![datax_framework_new](5_DataX.assets/ec7e36f4-6927-11e6-8f5f-ffc43d6a468b.png)
...
![datax_arch](5_DataX.assets/aa6c95a8-6891-11e6-94b7-39f0ab5af3b4.png)
...
- #### 极简的使用体验
  ...
  - 详细
    ...
    - 传输过程中打印传输速度、进度等	
      ...
      ![datax_run_speed](5_DataX.assets/d1612c0a-6891-11e6-9970-d6693c15ef24.png)

    - 传输过程中会打印进程相关的CPU、JVM等

      ![datax_run_cpu](5_DataX.assets/ee63c2fe-6891-11e6-9056-97d7e3d13d8d.png)

    - 在任务结束之后，打印总体运行情况

      ![datax_end_info](5_DataX.assets/0484d3ac-6892-11e6-9c1d-b102ad210a32.png)
